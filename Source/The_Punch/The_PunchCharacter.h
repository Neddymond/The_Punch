...
#include "The_PunchCharacter.generated.h"
...
enum class ELogLevel : uint8
{
	...
	WARNING				UMETA(DisplayName = "Warnning"),
...
UCLASS(config=Game)
class AThe_PunchCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
	...
	//AttackEnd - triggered  when the player stop an attack
	void AttackEnd();
